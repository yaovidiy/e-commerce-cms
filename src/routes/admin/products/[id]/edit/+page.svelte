				...
				<Card.Root>
					...
					<Card.Content>
						<select
							...
							class="bg-white border-input ring-offset-white flex h-10 w-full items-center justify-between rounded-md border px-3 py-2 text-sm"
						>
					...
					<Card.Content class="space-y-4">
						...
						<div class="space-y-2">
							...
							{#await getAllCategories()}
								<select
									disabled
									class="bg-white border-input ring-offset-white flex h-10 w-full items-center justify-between rounded-md border px-3 py-2 text-sm opacity-50"
								>
